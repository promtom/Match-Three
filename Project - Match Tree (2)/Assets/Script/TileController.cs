...
{    
    ...
    private void OnMouseDown()
    {
        ...
        else
        {
            ...
            {
                // Debug.Log("PrevSelect=" + previousSelected.name);
                // Debug.Log("NewSelect=" + this.name);
    ...
    #region Adjacent
        ...
        public List<TileController> GetAllAdjacentTiles()
        {
            ...
            Debug.Log("=====CALLING adjacentTiles=====");
            for (int i = 0; i < adjacentDirection.Length; i++)
            {
                adjacentTiles.Add(GetAdjacent(adjacentDirection[i]));
                Debug.Log(i + ". adjacentTiles = " + adjacentTiles[i]);
            }
            Debug.Log("=====END adjacentTiles=====");
